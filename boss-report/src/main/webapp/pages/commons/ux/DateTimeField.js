 ...
 * Provides a date input field with a {@link Ext.DateTimePicker} dropdown and automatic date validation.
 * @constructor
...
Ext.form.DateTimeField = Ext.extend(Ext.form.TriggerField,  {
     ...
     * <tt>false</tt> to hide the footer area of the DateTimePicker containing the Today button and disable
...
disabledDates: ["^03"]
    ...
    initComponent : function(){
        ...
        this.addEvents(
             ...
             * @param {Ext.form.DateTimeField} this
    ...
    initEvents: function() {
        Ext.form.DateTimeField.superclass.initEvents.call(this);
    ...
    /**
     * Replaces any existing <tt>{@link #minValue}</tt> with the new value and refreshes the DateTimePicker.
    ...
    /**
     * Replaces any existing <tt>{@link #maxValue}</tt> with the new value and refreshes the DateTimePicker.
    ...
    getErrors: function(value) {
        var errors = Ext.form.DateTimeField.superclass.getErrors.apply(this, arguments);
...
datetimeField.setValue(dt);

//Pass a date string (default format):
datetimeField.setValue('05/04/2006');

//Pass a date string (custom format):
datetimeField.format = 'Y-m-d';
datetimeField.setValue('2006-05-04');
</code></pre>
     * @param {String/Date} date The date or valid date string
     * @return {Ext.form.Field} this
     */
    setValue : function(date){
        return Ext.form.DateTimeField.superclass.setValue.call(this, this.formatDate(this.parseDate(date)));
    },
     ...
     */
    // private
    // Implements the default empty TriggerField.onTriggerClick function to display the DateTimePicker
    onTriggerClick : function(){
        ...
        this.menuEvents('on');
         //reportuser    
        if(!Ext.isEmpty(this.timeinit)&&this.format==='Ymd H:i:s'&&Ext.isEmpty(this.getValue())){
        		this.menu.picker.setValue(Date.parseDate(new Date().format('Ymd')+' '+this.timeinit,this.format));
        } else{
