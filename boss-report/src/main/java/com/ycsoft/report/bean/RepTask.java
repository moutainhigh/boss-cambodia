...
@POJO(tn = "REP_TASK", sn = "SEQ_REP_TASK_ID", pk = "TASK_ID")
public class RepTask implements Serializable {
	...
	private String is_dowload;
	private String is_delete;
	private String is_waitexec;
	...
	public String getIs_waitexec() {
		return is_waitexec;
	}
	public void setIs_waitexec(String is_waitexec) {
		this.is_waitexec = is_waitexec;
	}
	public String getIs_dowload() {
		return is_dowload;
	}
	public void setIs_dowload(String is_dowload) {
		this.is_dowload = is_dowload;
	}
