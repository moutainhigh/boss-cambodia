...
public class JsonHelper {
	...
	//时间格式是 yyyy-MM-dd
	public static Gson gsonYmd = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
	...
	public static <T,K> Map<T,K> toMap(String json, Type type)throws Exception{
		
		Map<T,K> r = gson.fromJson(json, type);
		return r ;
	}
