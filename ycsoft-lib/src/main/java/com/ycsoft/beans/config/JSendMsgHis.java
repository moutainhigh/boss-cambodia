...
/**
 * JSendMsgHis -> J_SEND_MSG_HIS mapping 
 */
@POJO(
	tn="J_SEND_MSG_HIS",
	sn="",
	pk="")
public class JSendMsgHis implements Serializable {
	
	// JSendMsgHis all properties 

	/**
	 * 
	 */
	private static final long serialVersionUID = 8565837312809577742L;
