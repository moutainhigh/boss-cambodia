...
/**
 * CBankGotodisk -> C_BANK_GOTODISK mapping 
 */
@POJO(
	tn="C_BANK_GOTODISK",
	sn="",
	pk="trans_sn")
public class CBankGotodisk implements Serializable {
	
	// CBankGotodisk all properties 
	...
	/**
	 * @param prod_sn the prod_sn to set
	 */
