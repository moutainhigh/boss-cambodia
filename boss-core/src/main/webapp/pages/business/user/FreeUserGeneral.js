 ...
 * 免费终端
 */
FreeUserGeneralForm = Ext.extend( BaseForm , {
	...
	constructor: function(){
		...
		FreeUserGeneralForm.superclass.constructor.call(this, {
			border:false,
	...
	initComponent: function(){
		FreeUserGeneralForm.superclass.initComponent.call(this);
...
//			this.doLayout();
	...
	doValid:function(){
		return FreeUserGeneralForm.superclass.doValid.call(this);
	},
	getValues: function(){
		var ps = FreeUserGeneralForm.superclass.getValues.call(this);
...
Ext.onReady(function(){
	var ecf = new FreeUserGeneralForm();
