...
Ext.ux.form.LovCombo = Ext.extend(Ext.form.ComboBox, {   
    ...
    ,onBeforeQuery:function(qe) {   
    	var str = this.getCheckedDisplay();
    	str = Ext.isEmpty(str) ? '' : str;
    	str = str.filterSpecChar();
        qe.query = qe.query.replace(new RegExp(str  + '[ ' + this.separator + ']*'), '');   
    ...
    ,onRealBlur:function() {   
        ...
        //下面的代码因为displayField 有多个一样的情况下,会出现选择一个,就会把所有的都选中的BUG
        /*
...
Ext.ux.LovCombo = Ext.ux.form.LovCombo;